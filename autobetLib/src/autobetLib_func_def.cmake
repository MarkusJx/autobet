    ...
    if (EXISTS ${GIT_PATH})
        ...
        if (${GIT_RES} STREQUAL "0")
            ...
            if (${GIT_RES} STREQUAL "0")
                ...
                message(ERROR "Could not clone repository")
            endif ()
        endif ()
    else ()
        # Git is not installed, cannot download CppJsLib
        message(ERROR "Git is not installed, cannot clone repository")
    endif ()
...
function(downloadCppJsLib)
    ...
    if (NOT EXISTS ${CPPJSLIB_DIRECTORY})
        message(ERROR "${CPPJSLIB_DIRECTORY} does not exist, cannot continue")
    endif ()
...
function(downloadZip)
    ...
    if (NOT EXISTS ${ZIP_DIRECTORY})
        message(ERROR "${ZIP_DIRECTORY} does not exist, cannot continue")
    endif ()
...
function(downloadAiDll)
    ...
    if (NOT EXISTS ${AI_DLL_FILE})
        message(ERROR "${AI_DLL_FILE} does not exist, cannot continue")
    else ()
...
function(downloadAiLib)
    ...
    if (NOT EXISTS ${AI_LIB_FILE})
        message(ERROR "${AI_LIB_FILE} does not exist, cannot continue")
    else ()
